...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo "2. Set up ngrok authentication (done automatically)"
    echo "3. Start ngrok: ngrok http 3000"
    echo "4. Update HOST_APP with ngrok URL"
    echo "5. Run the application: python call_hiss.py"
    echo ""
    echo "📚 Required Environment Variables:"
    echo "   export SPACE_URL=saorsadev.signalwire.com"
    ...
    echo "   export NGROK_AUTHTOKEN=2xUu328LKTtLJ8LeYDW4i3J6r8g_7KDyw9tey5bRVv6F4mYo7"
