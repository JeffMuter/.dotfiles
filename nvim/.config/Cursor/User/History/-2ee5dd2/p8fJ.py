#!/usr/bin/env python3
"""
Test AI Call with Proper Webhooks
"""
...
def test_ai_call():
    print("🎵 Testing AI Call with Webhooks")
    print("=" * 40)
    ...
    # Get user input
    user_prompt = "Hi! This is a test call from the CallHiss AI assistant. I'm calling to verify that the AI agent is working properly. Can you hear me clearly?"
    ...
    try:
        ...
        print(f"\n💡 The AI will:")
        print(f"   1. Greet you politely")
        print(f"   2. Deliver the test message")
        print(f"   3. Ask if you can hear clearly")
        print(f"   4. Have a conversation with you!")
