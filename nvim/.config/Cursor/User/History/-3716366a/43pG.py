...
class CallHiss:
    ...
    def setup_routes(self):
        ...
        def ai_agent():
            ...
            # Use SignalWire AI method directly on VoiceResponse
            ai = response.ai()
            ai.prompt(ai_prompt)
            ai.voice = "en-US-Neural2-D"
            ai.post_prompt_url = f"{self.host}/summary"
            ai.post_prompt("Return a JSON object with the call results: {\"call_completed\": true/false, \"response_received\": \"RESPONSE\", \"notes\": \"NOTES\"}")
