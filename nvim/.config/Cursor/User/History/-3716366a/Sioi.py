        ...
        def ai_agent():
            ...
            if speech_result:
                ...
                if should_end_call:
                    ...
                    # Listen for another response - NO fallback here
                    response.gather(
                        input='speech',
                        timeout=10,
                        speech_timeout='auto',
                ...
                # Check if this is the initial call or a timeout
                if 'Digits' not in request.form and 'SpeechResult' not in request.form:
                    ...
                    # Use Gather to listen for user response - NO fallback here
                    response.gather(
                        input='speech',
                        timeout=10,
                        speech_timeout='auto',
                    ...
                    # This is a timeout - user didn't respond, generate fallback and end call
