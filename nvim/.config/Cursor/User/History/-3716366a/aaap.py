    ...
    def setup_routes(self):
        ...
        def ai_agent():
            ...
            connect.ai(
                ...
                post_prompt_url=f"{self.host}/summary",
                post_prompt={
                    "text": "Return a JSON object with the call results: {\"call_completed\": true/false, \"response_received\": \"RESPONSE\", \"notes\": \"NOTES\"}"
                }
            )
