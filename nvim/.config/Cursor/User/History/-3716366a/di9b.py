        ...
        def ai_agent():
            ...
            if speech_result:
                ...
                if should_end_call:
                    ...
                    response.say(ai_response)
                    response.say("Is there anything else you'd like to discuss?")
                    ...
                    response.say("I didn't catch that. Feel free to say goodbye if you'd like to end the call.")
                    response.gather(
                        input='speech',
                        timeout=10,
                        speech_timeout='auto',
                    ...
                    # Final fallback
                    response.say("Thanks for the conversation! I'll end the call now. Goodbye!")
                    response.hangup()
            else:
                ...
                response.say("How are you doing today?")
                ...
                # Fallback if no response
                response.say("I didn't hear a response. Are you there? Please say something!")
                response.gather(
                    input='speech',
                    timeout=10,
                    speech_timeout='auto',
