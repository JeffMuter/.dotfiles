...
class CallHiss:
    ...
    def setup_routes(self):
        ...
        def ai_agent():
            ...
            # For testing, just use a simple Say response
            response.say("Hello! This is a test of the CallHiss AI system. I can hear you clearly. The AI agent is working!")
            response.say("This confirms that the webhook is functioning properly.")
            response.hangup()
