...
def make_call(call_details):
    ...
    try:
        ...
        # Store the prompt in environment for the webhook
...
Your objective is: {call_details.objective}"""
        ...
        # Use localhost for development, but this should be your public webhook URL in production
        webhook_url = "http://localhost:5000/ai-webhook"
