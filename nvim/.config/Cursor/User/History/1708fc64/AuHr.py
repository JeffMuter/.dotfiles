...
class TinyLlamaModel(LLMInterface):
    ...
    def __init__(self):
        ...
        self.tokenizer = None
        self.pipeline = None
        self.max_new_tokens = 75  # Set a consistent token limit
    ...
    def generate_response(self, prompt: str, max_length: Optional[int] = None) -> str:
        ...
        try:
            ...
            try:
                # Split on the assistant marker and get everything after it
                response = response.split("<|im_start|>assistant\n")[1].strip()
                # Remove any remaining end markers
