...
def test_login_success(client, test_user):
    ...
    assert b'Login successful!' in response.data, "Login success message not found"
...
def test_login_wrong_password(client, test_user):
    ...
    assert response.status_code == 200, "Login request failed"
    assert b'Invalid email or password' in response.data, "Wrong password error message not found"
...
def test_login_nonexistent_user(client):
    ...
    assert response.status_code == 200, "Login request failed"
    assert b'Invalid email or password' in response.data, "Non-existent user error message not found"
...
def test_signup_success(client, db_session):
    ...
    assert b'Registration successful!' in response.data, "Registration success message not found"
...
def test_signup_duplicate_email(client, test_user):
    ...
    assert response.status_code == 200, "Registration request failed"
    assert b'Email already registered' in response.data, "Duplicate email error message not found"
